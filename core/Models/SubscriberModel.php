...
class SubscriberModel extends Model
{
	...
	public function recordLastActivity($id)
	{
		...
		// Debugging: Log the tokens to check for mismatches
		error_log("Session Token: $curentUserToken | DB Token: $userToken");

		if ($curentUserToken <> $userToken) {
			// Log why the user is being logged out
			error_log("User $id logged out due to token mismatch.");
			return 1; // Logout User Response Code
		}
