        ...
        <div class="card card-style bg-theme pb-0">
            <div class="content" id="tab-group-1">
                ...
                <div class="text-center">
                    ...
                    <?php if(!empty($data->sFidelityBank) && $controller->getConfigValue($data2,"monifyFeStatus") == "On"): ?>
                    ...
                    <hr/>
                    <?php endif; if(!empty($data->sRolexBank) && $controller->getConfigValue($data2,"monifyMoStatus") == "On"): ?>
                    ...
                    <hr/>
                    <?php endif; if(!empty($data->sBankNo) && $controller->getConfigValue($data2,"monifyWeStatus") == "On"): ?>
                    ...
                    <hr/>
                    <?php endif; if(!empty($data->sSterlingBank) && $controller->getConfigValue($data2,"monifySaStatus") == "On"): ?>
