        ...
        <div class="card card-style">
            <div class="content">
                ...
                <div class="list-group list-custom-small">
                    <a href="#">
                        <input type="text" class="form-control" readonly value="<?php echo $data9->sApiKey; ?>" />
                            <button class="btn btn-danger btn-sm" onclick="copyToClipboard('<?php echo $data9->sApiKey; ?>')">Copy API Key</button>
                    </a>
                    <a href="https://documenter.getpostman.com/view/21101634/2sA2xnyA6T" target="blank">
                            <button class="pl-5 btn btn-success btn-sm">API Documentation Page</button>
                    </a>
                </div>
                <br>
                <hr>
