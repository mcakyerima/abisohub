            ...
            <div class="content">
                ...
                <div class="row text-center mb-2">
                    ...
                    <a href="javascript:selectNetworkByIcon('AIRTEL');" class="col-3 mt-2">
                        <span class="icon ic4rt5on-l rounded-sm py-2 px-2" style="background:#f2f2f2;">
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                ...
                                <select id="networkid" name="network">
                                    ...
                                    <?php foreach($data AS $network): if($network->networkStatus == "On"): ?>
                                        <option value="<?php echo $network->nId; ?>" networkname="<?php echo $network->network; ?>" sme="<?php echo $network->smeStatus; ?>" gifting="<?php echo $network->giftingStatus; ?>" share="<?php echo $network->shareStatus; ?>" corporate="<?php echo $network->corporateStatus; ?>"><?php echo $network->network; ?></option>
